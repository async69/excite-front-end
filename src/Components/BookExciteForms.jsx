...
export const BookExciteForm = (props) => {
  ...
  const thumbs = files.map((file) => (
    <div className="thumb" key={file.name}>
      <div className="thumbInner">
        <img src={file.preview} className="thumbImg" />
      </div>
    </div>
  ));
...
export function BookExciteform1() {
  return <div >  this is form 1</div>;
}

export function BookExciteform2() {
  return <div>this is form 2</div>;
}

export function BookExciteform3() {
  return <>this is form 3 </>;
}
